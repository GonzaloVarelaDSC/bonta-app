...
import type {
  User, Client, Job, Comment, ActivityLogEntry, Notification,
} from '../types';
import { QC_TEMPLATE } from './catalog';

// ---------- Usuarios ----------
export const USERS: User[] = [
  { id: 'u-marcela', name: 'Marcela Bonta', email: 'marcela@estudiobonta.com', role: 'admin', sector: 'Dirección', avatarColor: '#0f4c3a', active: true, isProducer: false, creditsAsAssigner: true },
  { id: 'u-juan', name: 'Juan Pérez', email: 'juan@estudiobonta.com', role: 'coordinador', sector: 'Coordinación', avatarColor: '#146b52', active: true, isProducer: false, creditsAsAssigner: true },
  { id: 'u-maria', name: 'María Gómez', email: 'maria@estudiobonta.com', role: 'diseno', sector: 'Diseño', avatarColor: '#7c3aed', active: true, isProducer: true, creditsAsAssigner: true },
  { id: 'u-lucia', name: 'Lucía Fernández', email: 'lucia@estudiobonta.com', role: 'diseno', sector: 'Diseño', avatarColor: '#9333ea', active: true, isProducer: true, creditsAsAssigner: true },
  { id: 'u-pedro', name: 'Pedro Ramírez', email: 'pedro@estudiobonta.com', role: 'produccion', sector: 'Producción', avatarColor: '#c2410c', active: true, isProducer: true, creditsAsAssigner: true },
  { id: 'u-diego', name: 'Diego Sosa', email: 'diego@estudiobonta.com', role: 'produccion', sector: 'Producción', avatarColor: '#b45309', active: true, isProducer: true, creditsAsAssigner: true },
  { id: 'u-nahuel', name: 'Nahuel Torres', email: 'nahuel@estudiobonta.com', role: 'instalacion', sector: 'Instalación', avatarColor: '#0369a1', active: true, isProducer: true, creditsAsAssigner: true },
  { id: 'u-gonzalo', name: 'Gonzalo Varela', email: 'gonzalo@estudiobonta.com', role: 'coordinador', sector: 'Diseño Industrial / Producción', avatarColor: '#0f4c3a', active: true, isProducer: true, creditsAsAssigner: true },
];
...
const S: Seed[] = [
  { code: 'TRB-2026-00458', name: '20 carteles de sucursal', clientId: 'c-lacoste', contactName: 'Sofía Márquez',
    ...
    requiresInstallation: true, installAddress: 'Múltiples sucursales AMBA',
  ...
  { code: 'TRB-2026-00462', name: 'Letras corpóreas iluminadas fachada', clientId: 'c-farmaplus', contactName: 'Estela Núñez',
    ...
    requiresInstallation: true, installAddress: 'Av. Cabildo 2140, CABA', lastActivityHoursAgo: 30 },
  ...
  { code: 'TRB-2026-00463', name: 'Stand feria Pinturería Expo', clientId: 'c-sinteplast', contactName: 'Hernán López',
    ...
    requiresInstallation: true, installAddress: 'La Rural, CABA (montaje in situ)', lastActivityHoursAgo: 8 },
  ...
  { code: 'TRB-2026-00464', name: 'Trofeos torneo interno', clientId: 'c-sinteplast', contactName: 'Hernán López',
    ...
    observations: '', createdDaysAgo: 3, committedInHours: 200, status: 'DISENO_LISTO', lastActivityHoursAgo: 14 },
  ...
  { code: 'TRB-2026-00466', name: 'Backlight cartel de local', clientId: 'c-farmaplus', contactName: 'Estela Núñez',
    ...
    observations: '', createdDaysAgo: 8, committedInHours: -20, status: 'EN_CONTROL_CALIDAD',
  ...
  { code: 'TRB-2026-00467', name: 'Ambientación local temporada', clientId: 'c-victoriasecret', contactName: 'Camila Suárez',
    ...
    observations: '', createdDaysAgo: 2, committedInHours: 50, status: 'EN_DISENO',
  ...
  { code: 'TRB-2026-00468', name: 'Piezas especiales exhibidor', clientId: 'c-lacoste', contactName: 'Sofía Márquez',
    ...
    status: 'EN_DISENO', clientImportant: true, lastActivityHoursAgo: 2 },
  ...
  { code: 'TRB-2026-00469', name: 'Vinilos flota de vehículos', clientId: 'c-subway', contactName: 'Ramiro Díaz',
    ...
    observations: '', createdDaysAgo: 1, committedInHours: 4, status: 'EN_PRODUCCION',
  ...
  { code: 'TRB-2026-00470', name: 'Cartel bajo acrílico placa institucional', clientId: 'c-galicia', contactName: 'Valentina Ríos',
    ...
    observations: '', createdDaysAgo: 12, committedInHours: 300, status: 'PENDIENTE',
  ...
  { code: 'TRB-2026-00471', name: 'Gráfica evento lanzamiento', clientId: 'c-subway', contactName: 'Ramiro Díaz',
    ...
    status: 'EN_PRODUCCION', requiresInstallation: true, installAddress: 'Centro de convenciones, CABA',
    clientImportant: true, lastActivityHoursAgo: 3 },
  ...
  { code: 'TRB-2026-00472', name: 'Reposición vinilo dañado vidriera', clientId: 'c-carrefour', contactName: 'Martín Acosta',
    ...
    createdDaysAgo: 0, committedInHours: 2, status: 'PENDIENTE', requiresInstallation: true,
  ...
  { code: 'TRB-2026-00473', name: 'Cartel MDF pintado local nuevo', clientId: 'c-farmaplus', contactName: 'Estela Núñez',
    ...
    status: 'FALTA_INFORMACION', lastActivityHoursAgo: 0.2 },
  ...
  { code: 'TRB-2026-00474', name: 'Corte láser piezas MDF exhibidor', clientId: 'c-sinteplast', contactName: 'Hernán López',
    ...
    createdDaysAgo: 2, committedInHours: 130, status: 'PENDIENTE', lastActivityHoursAgo: 40 },
  ...
  { code: 'TRB-2026-00475', name: 'Cartel backlight cancelado por cliente', clientId: 'c-galicia', contactName: 'Valentina Ríos',
    ...
    createdDaysAgo: 20, committedInHours: -100, status: 'CANCELADO', lastActivityHoursAgo: 96 },
  ...
  { code: 'TRB-2026-00476', name: 'Vidriera navideña — control final', clientId: 'c-lacoste', contactName: 'Sofía Márquez',
    ...
    createdDaysAgo: 9, committedInHours: 8, status: 'LISTO_PARA_INSTALACION', requiresInstallation: true,
  ...
  { code: 'TRB-2026-00477', name: 'Cartel de piso entregado', clientId: 'c-carrefour', contactName: 'Martín Acosta',
    ...
    createdDaysAgo: 14, committedInHours: -80, status: 'TERMINADO', lastActivityHoursAgo: 70, fileApproved: true },
];
