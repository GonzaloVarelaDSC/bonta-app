...
export function UsersPage() {
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <p className="text-sm text-ink-500 mb-5">Alta, baja y roles. La creación de nuevas cuentas queda conectada al backend real en Fase 2 — por ahora se administra el estado de las cuentas de prueba.</p>
          ...
          <div key={u.id} className="flex items-center justify-between px-4 py-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-ink-400">{u.email} · {ROLES.find((r) => r.id === u.role)?.label} · {u.sector}</div>
              </div>
            </div>
